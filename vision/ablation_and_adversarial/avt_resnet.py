...
class Regressor(nn.Module):
    def __init__(self, resnet_type=34, indim=1024, num_classes=8): #indim = [orig_img_features,transformed_img_features], num_classes is the number of possible transformations
