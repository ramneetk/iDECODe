...
class CIFAR10(data.Dataset):
    ...
    def __init__(self, root, shift=6, scale=None, resample=False, fillcolor=0, train=True,
                 ...
                 download=True, cal=False, proper_train_size=45000):
        ...
        if self.train or self.cal:
            ...
            if self.train: # proper training set
                ...
                self.train_data = self.train_data[proper_train_size:50000]
                self.train_labels = self.train_labels[proper_train_size:50000]
